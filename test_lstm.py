...
with torch.no_grad():
    ...
    for i, batch in tqdm(enumerate(test_loader)):
        ...
        chg_pos_feat_bef, chg_pos_feat_aft, chg_pos_feat_diff,_ = change_detector(d_feats, sc_feats)
        chg_neg_logits, chg_neg_att_bef, chg_neg_att_aft, \
        chg_neg_feat_bef, chg_neg_feat_aft, chg_neg_feat_diff,_ = change_detector(d_feats, nsc_feats)
