...
from models.modules_MARL import ChangeDetectorDoubleAttDyn, AddSpatialInfo
...
while t < cfg.train.max_iter:
    ...
    for i, batch in enumerate(train_loader):
        ...
        chg_pos_feat_bef, chg_pos_feat_aft, chg_pos_feat_diff, contra_pos = change_detector(d_feats, sc_feats)
        chg_neg_logits, chg_neg_att_bef, chg_neg_att_aft, \
        chg_neg_feat_bef, chg_neg_feat_aft, chg_neg_feat_diff, contra_neg = change_detector(d_feats, nsc_feats)
        ...
        total_loss = speaker_loss + 0.4 * speaker_pos_loss + 2.5e-03 * att_sum + entropy_loss + 0.1 * contra_loss # pos0.4, contra0.1
